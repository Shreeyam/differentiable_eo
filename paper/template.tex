...
\title{Differentiable Satellite Constellation Configuration via Relaxed Coverage and Revisit Objectives}
...
\author{
    ...
    \And
    \href{https://orcid.org/0000-0002-7791-5124}{\includegraphics[scale=0.06]{orcid.pdf}\hspace{1mm}Kerri Cahoy} \\
    Department of Aeronautics and Astronautics\\
    MIT\\
