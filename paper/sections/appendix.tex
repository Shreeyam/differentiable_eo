...
Several natural alternatives to R1, R2, and R4 reduce to the chosen relaxations up to reparameterisation or additive constants. Hence,wapping in the alternatives would not produce different optimizer dynamics.
