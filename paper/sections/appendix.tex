...
We record these identities because they explain why swapping in the alternative would not produce different optimiser dynamics.
...
Since gradients are invariant under additive constants, the optimiser sees identical dynamics; using mellowmax here would be a relabelling of LogSumExp rather than a different relaxation.